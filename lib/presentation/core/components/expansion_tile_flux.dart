// Copy pasta from flutter source code. Modified to not
// accept trailings and remove elevation/border
...
/// [ExpansionTileFlux] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
class ExpansionTileFlux extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ExpansionTileFlux({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  _ExpansionTileFluxState createState() => _ExpansionTileFluxState();
}

class _ExpansionTileFluxState extends State<ExpansionTileFlux>
